...
const TotalBill = () => {
    ...
    const TotalTip = ((((Tip / 100) + (friendTip / 100)) / 2) * BillNumber)
    const roundedTotalTip = parseFloat(TotalTip.toFixed(1))
    ...
    return (
        <div>
            ...
            {BillNumber ? <h1 className='text-2xl font-bold mx-2 pt-2'>You pay ${TotalFee}(${BillNumber} + ${roundedTotalTip} tip)</h1> : null}
